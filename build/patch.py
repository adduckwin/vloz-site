...
rep('    <a href="#contact" class="nav-cta"><svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor"><path d="M22 3 2 11l5 2 2 6 3-4 5 4 5-16Z"/></svg><span>Telegram</span></a>',
    '    <a href="blog.html" class="nav-blog">Блог</a>\n    <div class="nav-acts"><a href="https://max.ru/u/ВАШ_ХЕШ" class="nav-max"><svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 5h16v11H8l-4 4z"/></svg><span>MAX</span></a><a href="#contact" class="nav-cta"><svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor"><path d="M22 3 2 11l5 2 2 6 3-4 5 4 5-16Z"/></svg><span>Telegram</span></a></div>', 'nav blog link')
