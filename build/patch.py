...
rep('<div class="brand"><span class="o"></span>Сезон</div>',
    '<div class="brand"><span class="o"></span>VLOZ</div>', 'nav brand')
...
ANALYTICS = '''<!-- ВСТАВЬТЕ ID СЧЁТЧИКОВ НИЖЕ -->
...
ym(00000000, "init", {clickmap:true,trackLinks:true,accurateTrackBounce:true});  /* <-- ваш номер счётчика Яндекс.Метрики */
</script>
